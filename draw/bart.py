...
# 添加标题和标签
ax.set_xlabel('', x=0.5, fontdict={'family': 'Times New Roman', 'size': 16})
plt.ylabel('Performance(%)', fontdict={'family': 'Times New Roman', 'size': 16})
plt.xticks(fontproperties = 'Times New Roman', size = 16)
plt.yticks(fontproperties = 'Times New Roman', size = 14)

# 设置纵坐标数值范围
ax.set_ylim(45, 80)  # 将纵坐标的数值范围设置为0到100
...
# 删除默认的图例标题
ax.legend(title='', prop={'family': 'Times New Roman', 'size': 10})
